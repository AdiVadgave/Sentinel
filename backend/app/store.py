...
def _seed() -> dict:
    return {
        ...
        "users": [
            ...
            {"id": "u-modau", "name": "Dr Emily Carter", "role": "HSE Manager", "title": "Chief HSE & ESG Manager", "area": "", "initials": "EC"},
            {"id": "u-admin", "name": "Michael Brooks", "role": "Admin", "title": "IT / Platform Admin", "area": "", "initials": "MB"},
        ],
        "integrations": [
