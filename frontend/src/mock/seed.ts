...
export const users: User[] = [
  ...
  { id: "u-modau", name: "Dr Emily Carter", role: "HSE Manager", title: "Chief HSE & ESG Manager", initials: "EC" },
  { id: "u-admin", name: "Michael Brooks", role: "Admin", title: "IT / Platform Admin", initials: "MB" },
];
...
export const sops: Sop[] = [
  ...
  { id: "SOP-LOTO-007", title: "Lockout / Tagout — Energy Isolation", type: "SOP", version: "v4.0", owner: "P. van Wyk", approved: "28 Feb 2026", status: "Current" },
  { id: "SOP-CS-009", title: "Confined Space Entry", type: "SOP", version: "v2.3", owner: "N. Dlamini", approved: "15 Mar 2026", status: "Current" },
  { id: "SOP-ME-021", title: "Mobile Equipment Operation", type: "SOP", version: "v1.8", owner: "P. van Wyk", approved: "11 Jan 2026", status: "Review due" },
...
export const workItems: WorkItem[] = [
  ...
  { id: "NM-2026-0331", type: "Near-Miss", title: "Tool dropped from conveyor gantry", area: "Gamsberg Concentrator", reportedBy: "P. van Wyk", status: "Closed", agent: "incident-investigation", ageHrs: 280, severity: "Medium" },
  ...
  { id: "NM-2026-0318", type: "Near-Miss", title: "Mobile equipment proximity — pedestrian", area: "Swartberg", reportedBy: "N. Dlamini", status: "Approved", agent: "incident-investigation", ageHrs: 120, severity: "High" },
...
export const correctiveActions: CorrectiveAction[] = [
  ...
  { id: "CA-0913", action: "Issue tethered-tool kits to crusher maintenance crews", owner: "P. van Wyk", due: "18 Jul 2026", priority: "High", status: "Submitted" },
  { id: "CA-0908", action: "Re-train C-Shift on dropped-object prevention", owner: "N. Dlamini", due: "04 Jul 2026", priority: "Medium", status: "Approved" },
  { id: "CA-0901", action: "Install proximity-detection on EX-204 haul route", owner: "M. Brooks", due: "29 Jun 2026", priority: "High", status: "Closed" },
