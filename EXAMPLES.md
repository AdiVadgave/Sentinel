# Zen-Sentinel — Examples: "you type → the AI responds"
...
**Zen-Sentinel responds:** *Yes — a spotter (banksman) is required for pedestrian-vehicle interaction in
...
**Zen-Sentinel responds (on submit):**
- **Category:** Slip/Trip
...
**Zen-Sentinel responds:** a concise controls-confirmation paragraph written from your selected hazards and
...
**Zen-Sentinel responds:** a full **ICAM** draft —
...
1. Click **AI draft summary** → Zen-Sentinel writes a professional handover narrative for the incoming shift (work completed, equipment flagged like EX-204, carried-over actions CA-0912 / CA-0913, pending permits), and the completeness meter animates 62% → 94%.
...
**Zen-Sentinel responds:** the pattern card shows the mock event data (4 dropped-object near-misses at the
...
**Zen-Sentinel responds:** a live-generated report (title, period, executive summary, 3–4 sections) tailored to the type:
...
**Zen-Sentinel shows:** every AI answer and human sign-off captured with **user, agent, action,
...
**Zen-Sentinel responds:** the live analysis is skipped (the agent is disabled) and the page falls back to
